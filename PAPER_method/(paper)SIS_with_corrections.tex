...
\begin{figure*}
    \subfloat[fig 1]{\includegraphics[width=0.5\linewidth]{Fig1.PNG}}
    \subfloat[fig 2]{\includegraphics[width=0.5\linewidth]{Fig2.PNG}}\\
    \subfloat[fig 3]{\includegraphics[width=0.5\linewidth]{Fig3.PNG}}
    \subfloat[fig 4]{\includegraphics[width=0.5\linewidth]{Fig4.PNG}}\\
    \subfloat[fig 5]{\includegraphics[width=0.5\linewidth]{Fig5.PNG}}
...
The results for the AR(1) model compared to the gold standard show that our simulations closely approximate analytical solutions, while the river example shows the applicability of the method to a simple invasive species problem.
...
\bibitem [\protect\citeauthoryear{Seif}{2017}]{Seif} 
