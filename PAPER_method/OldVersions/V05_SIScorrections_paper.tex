...
{\color{blue} Sequential importance sampling, a form of Particle filter, was firstly introduced by \cite{Kong} and have been used in Bayesian missing data problems in the form of sequential imputation, in situations where the posterior must be constantly updated with the arrival of new data.}
