...
We also introduce a new model for the Red Imported Fire Ants invasion in Brisbane Australia based on a self-exciting spatial temporal process and then apply th novel Sequential Importance Sampling methodology to infer the locations of unobserved nests each time we receive a new set of observations.
\end{abstract}